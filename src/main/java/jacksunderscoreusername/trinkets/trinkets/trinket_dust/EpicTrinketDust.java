...
public class EpicTrinketDust extends Item {
    ...
    public static Settings getSettings() {
        return new Settings().rarity(Rarity.EPIC);
    }

    public EpicTrinketDust(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.literal("Right click while holding").formatted(Formatting.LIGHT_PURPLE, Formatting.ITALIC));
        tooltip.add(Text.literal("a trinket in your offhand").formatted(Formatting.LIGHT_PURPLE, Formatting.ITALIC));
        tooltip.add(Text.literal("to upgrade it").formatted(Formatting.LIGHT_PURPLE, Formatting.ITALIC));
    }
}
