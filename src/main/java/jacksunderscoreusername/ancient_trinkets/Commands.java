        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) ->
                dispatcher.register(CommandManager.literal("listTrinkets")
                        .executes(context -> {
                            ...
                            context.getSource().sendFeedback(() -> Text.literal(finalOpenCount + "/" + Trinkets.allTrinkets.size() + " ancient_trinkets can still be claimed"), false);
                            return 1;
                        })));
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) ->
                dispatcher.register(CommandManager.literal("unclaimTrinkets")
                        ...
                        .executes(context -> {
                            ...
                            context.getSource().sendFeedback(() -> Text.literal("Unclaimed all ancient_trinkets"), true);
                            return 1;
                        })));
