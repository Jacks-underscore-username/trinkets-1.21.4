...
/**
 * Represents the model of a {@linkplain jacksunderscoreusername.ancient_trinkets.trinkets.soul_lamp.GhostEntity}.
 *
 * <div class="fabric">
 * <table border=1>
...
public class GhostEntityModel extends EntityModel<GhostEntityRenderState> implements ModelWithArms {
    ...
    public void setAngles(GhostEntityRenderState vexEntityRenderState) {
